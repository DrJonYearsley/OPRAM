...
compareOpram_vs_MetOffice.R    | Import OPRAM results using UK Met Office data and Met Eireann data and quantify the discrepancy   
view_records.R   | View GBIF and NBN records (in development)    